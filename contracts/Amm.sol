...
contract Amm is IAmm, UniswapV2ERC20 {
    ...
    function getQuoteAmountByCurrentPrice(int112 baseTokenAmount ) internal returns(int112 quoteTokenAmount) {
    ...
    function burn(address to) external lock returns (uint amount0, uint amount1) {
        (uint112 _baseReserve, uint112 _quoteReserve,) = getReserves(); // gas savings
        address _token0 = baseToken;                                // gas savings
        address _token1 = quoteToken;                                // gas savings
