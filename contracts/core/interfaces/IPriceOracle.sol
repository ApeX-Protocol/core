...
interface IPriceOracle {
    ...
    function getMarkPriceAfterSwap(address amm, uint256 quoteAmount) external view returns (uint256 price, bool isIndexPrice);

    function getMarkPriceInRatio(address amm, uint256 quoteAmount) external view returns (uint256 baseAmount, bool isIndexPrice);
