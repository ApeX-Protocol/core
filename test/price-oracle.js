...
describe("PriceOracle contract", function () {
    ...
    beforeEach(async function () {
        ...
        oracle = await PriceOracle.deploy(factory.address);
    });
    ...
    describe("quote", function () {
        ...
        it("quote big number", async function () {
            let quoteAmount = await oracle.quote(baseToken.address, quoteToken.address, BigNumber.from("100000000000000000000"));
            console.log("quoteAmount:", BigNumber.from(quoteAmount).toString());
        });
    });
