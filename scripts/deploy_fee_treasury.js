...
const main = async () => {
  ...
  const rewardForStaking = "0x1956b2c4C511FDDd9443f50b36C4597D10cD9985";
  const rewardForCashback = "0x1956b2c4C511FDDd9443f50b36C4597D10cD9985";
  ...
  let feeTreasury = await FeeTreasury.deploy(
    v3Router,
    usdc,
    operator,
    rewardForStaking,
